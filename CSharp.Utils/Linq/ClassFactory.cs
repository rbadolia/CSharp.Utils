...
namespace CSharp.Utils.Linq
{
    internal class ClassFactory
    {
        ...
        private Type CreateDynamicClass(IList<DynamicProperty> properties)
        {
        ...
        private FieldBuilder[] GenerateProperties(TypeBuilder tb, IList<DynamicProperty> properties)
        {
